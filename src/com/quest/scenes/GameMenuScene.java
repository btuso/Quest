...
public class GameMenuScene extends Scene implements GameFlags,IOnSceneTouchListener{
	...
	private float mSkillScrollLastX = 0; // La vieja posici del dedo haciendo scroll.
	private float mSkillScrollNewX = 0; // La nueva posici del dedo haciendo scroll.
	...
	private short mSkillScrollLastAction = 0; // Si movi�a la derecha (1), izquierda (2), o ning佖 lado (0).
		...
		this.mSkillTreeBackgroundSprite = new Sprite(0, 0,this.mSkillTreeBackgroundTextureRegion,Game.getInstance().getVertexBufferObjectManager()) {
			...
			case TouchEvent.ACTION_MOVE:
				...
				if(this.mGrabbed) {
					...
					// pantalla. En resoluci width 800, hay 21 pixeles que separan la imagen de los bordes horizontales.
